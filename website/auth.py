...
@auth.route('/sign-up') # When you go to /sign-up page sign_up() function will be executed
def sign_up():
...
# ------------------------------------------------------------
@auth.route('/login') # When you go to /login page login() function will be executed
def login():
